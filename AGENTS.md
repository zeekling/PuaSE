...
- **目录不是平的**：`architect.md`、`code-reviewer.md`、`documenter.md`、`quality-inspector.md` 在 `subagent/` 根；`developer/` 下有 `java-developer.md`、`python-developer.md`；`security/` 下有 `security-expert.md`。
