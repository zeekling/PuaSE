...
- **目录不是平的**：`architect.md`、`code-reviewer.md`、`documenter.md`、`quality-inspector.md` 在 `subagent/` 根；`developer/` 下有 `cpp-developer.md`、`java-developer.md`、`python-developer.md`、`web-developer.md`；`dba/` 下有 `mysql-dba.md`、`oracle-dba.md`；`security/` 下有 `security-expert.md`。
