const i18n = {
  ...
  zh: {
    ...
    'about.step4.desc': '强制输出 KPI 卡（🧪+🔍+🛡️）→ reflector 复盘总结 → 改进跟踪至闭环',

    // === Architecture ===
    'arch.title': '系统架构',
    'arch.orchestrator.desc': '解析需求 → 成熟度评估 → 委派专家 → Post-Code并行验收 → KPI卡 → 复盘闭环',
    'arch.connector': '委派 ↓',
    ...
    'agent.bigdata-developer.desc': '大数据开发',
    ...
    'caps.7.desc': '没有 KPI 卡的交付叫自嗨。Post-Code 默认并行 security-expert + code-reviewer + quality-inspector，任一不通过立即打回',
  ...
  en: {
    ...
    'about.step4.desc': 'Force KPI card output (🧪+🔍+🛡️) → reflector retrospective → improvement tracking to closure',

    // === Architecture ===
    'arch.title': 'System Architecture',
    'arch.orchestrator.desc': 'Parse needs → Maturity assess → Delegate experts → Post-Code parallel review → KPI card → Retrospective',
    ...
    'agent.bigdata-developer.desc': 'Big Data',
    ...
    'caps.7.desc': 'No KPI card = no delivery. Post-Code runs security-expert + code-reviewer + quality-inspector in parallel by default. Any rejection = immediate rework',
    ...
    'demo.out5e': '  ├─ Force KPI card output (quantified acceptance criteria)',
    'demo.out5f': '  ├─ All passed ✅',
    'demo.out5g': '  └─ Retrospective loop 🔄',
